      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <!-- Horizontal Form -->
            <form action ="${pageContext.request.contextPath}/admin/vol/upt" method ="post">
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  ...
                  <input type="datetime-local" class="form-control" id="inputEmail" name="vol.dateHeureDecollage" value="<%= vol.getDateHeureDecollage() %>" placeholder="2025-03-20 10:00" disabled>
                </div>
              </div>
              <div class="row mb-3">
                <label for="inputPassword3" class="col-sm-2 col-form-label">Dernière heure réservation </label>
                <div class="col-sm-10">
                  <input type="number" class="form-control" id="inputPassword" name="vol.dernierReservation" value="<%= vol.getDernierReservation() %>">
                </div>
              </div>
              <div class="row mb-3">
                  <label for="inputPassword3" class="col-sm-2 col-form-label">Dernière heure annulation </label>
                  <div class="col-sm-10">
                    <input type="number" class="form-control" id="inputPassword" name="vol.derniereAnnulation" value="<%= vol.getDerniereAnnulation() %>">
                  </div>
              </div>
              <div class="row mb-3">
              ...
              <% for(int i = 0; i<vol.getPrixVols().length ; i++ ) { 
                ...
                <div class="row mb-3"> 
                  ...
                  <input type="hidden" name="classeAvions[]" value="<%= prixVol.getClasseAvion().getId() %>" class="form-control" required>

                  <div class="col-3 form-floating">
                      <input type="text" name="prix[]" class="form-control" value="<%= prixVol.getPrix() %>" required>
                      <label>Prix</label>
                  </div>
                  <div class="col-3 form-floating">
                      <input type="text" name="nbs[]" class="form-control" value = "<%= promotion.getNb() %>" required>
                      <label>Nb promotion</label>
                  </div>
                  <div class="col-3 form-floating">
                      <input type="text" name="promotions[]" class="form-control" value = "<%= promotion.getPourcentage() %>" required>
